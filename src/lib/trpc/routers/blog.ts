...
const blogs = [
  ...
  { id: 2, title: "The Sattvic Diet: Nourishing Body and Mind", slug: "sattvic-diet-nourishing-body-and-mind", shortDesc: "Learn about the philosophy behind our nutritious, plant-based meal offerings.", imagePath: "/images/resources/food-serving.webp", category: "Nutrition", publishDate: new Date("2026-03-22"), metaTitle: null, metaDescription: null, content: "<p>At the heart of every meal we serve is the principle of sattvic nutrition — food that is pure, wholesome, and prepared with care.</p>" },
